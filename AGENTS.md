# Telemetry Export Receipts (`telemetry-export-receipts`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://telemetry-export-receipts.sociobot.in`. Artifact class: `web-with-backend`.
